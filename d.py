...
def main():
    ...
    reply = input("would you like to play again? (y/n): ").strip().lower() # remove whitespace and set to lowercase for more accuracy.
    if reply == 'y' or reply == 'yes': # allows any non y/yes answers to exit the game, not just n/no
        points = 0
        main()
    else:
        print("thanks for playing! goodbye.") # exit the game
        exit()
